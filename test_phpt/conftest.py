...
class PhptRunner(object):
    ...
    def run(self, _source):
        ...
        interp.setup(False, [self.filename])
        self.prepare_globals(self.space, interp)
        w_timezone_name = interp.config.get_ini_w('date.timezone')

        if w_timezone_name is not None:
            timezone_name = interp.space.str_w(w_timezone_name)
            if timezone_name:
                interp.timezone = default_timezone(interp, timezone_name)
        ...
        try:
            ...
            if bc is not None:
                interp.included_files.append(self.filename)
...
markers[array_test_dir] = {
    ...
    'array_keys_error.phpt': "Illegal offset type thrown too soon",
    ...
    'each.phpt': slow,
    'each_basic.phpt': "doesnt work properly",
    'each_variation4.phpt': "doesnt work properly",
    'each_variation5.phpt': "doesnt work properly",
    'each_variation6.phpt': "doesnt work properly",
    ...
    'key_exists_variation2.phpt': "php://memory",
...
markers[class_object_test_dir] = {
    'class_exists_variation_001.phpt': "__autoload ?",
    'class_exists_variation_002.phpt': "__autoload ?",
    'forward_static_call_001.phpt': "undefined function forward_static_call()",
    'forward_static_call_002.phpt': "undefined function forward_static_call()",
    'forward_static_call_003.phpt': "undefined function forward_static_call()",
    ...
    'get_class_vars_error.phpt': "undefined get_class_vars()",
    'get_class_vars_variation1.phpt': "undefined get_class_vars()",
    'get_class_vars_variation2.phpt': "undefined get_class_vars()",
    'get_declared_classes_basic_001.phpt': "undefined get_declared_classes()",
    'get_declared_classes_error_001.phpt': "undefined get_declared_classes()",
    'get_declared_classes_variation1.phpt': "undefined get_declared_classes()",
    'get_declared_interfaces_basic_001.phpt': "undefined get_declared_interfaces()",
    'get_declared_interfaces_error_001.phpt': "undefined get_declared_interfaces()",
    'get_declared_interfaces_variation1.phpt': "undefined get_declared_interfaces()",
    ...
    'get_object_vars_variation_003.phpt': "undefined function get_object_vars()",
    ...
    'method_exists_basic_001.phpt': "undefined function method_exists()",
    'method_exists_basic_002.phpt': "undefined function method_exists()",
    'method_exists_basic_003.phpt': "undefined function method_exists()",
    'method_exists_error_001.phpt': "undefined function method_exists()",
    'method_exists_variation_001.phpt': "undefined function method_exists()",
    'method_exists_variation_002.phpt': "undefined function method_exists()",
    'method_exists_variation_003.phpt': "undefined function method_exists()",
...
markers[math_test_dir] = {
    ...
    'pow.phpt': "unexpected 'T_EVAL'",
    'round.phpt': "unexpected 'T_EVAL'",
}
...
markers[file_test_dir] = {
    ...
    '005_variation.phpt': "missing sleep",
    'bug12556.phpt': "?",
    'bug22382.phpt': "?",
    'bug26003.phpt': "?",
    ...
    'bug43137.phpt': 'error in microtime arity',
    'bug20424.phpt': "missing stream_get_meta_data()",
    ...
    'bug27619.phpt': "missing stream_filter_append()",
    ...
    'bug39538.phpt': "?",
    'bug41655_1.phpt': "missing glob()",
    'bug41655_2.phpt': "missing glob()",
    ...
    'fgets_socket_variation2.phpt': "missing stream_socket_server()",
    ...
    'fread_socket_variation1.phpt': "missing stream_socket_server()",
    ...
    'glob_basic.phpt': "missing glob()",
    'glob_error.phpt': "missing glob()",
    'glob_variation2.phpt': "missing glob()",
    'glob_variation.phpt': "missing glob()",
...
markers[string_test_dir] = {
    ...
    'vfprintf_basic.phpt': "context",
    'vfprintf_error3.phpt': "context",
...
markers[general_test_dir] = {
    ...
    'get_defined_constants_basic.phpt': "not implemented",
    'get_defined_constants_error.phpt': "not implemented",
    ...
    'ob_get_length_basic.phpt': "undefined ob_get_length()",
...
markers[classes_test_dir] = {
    ...
    'constants_basic_006.phpt': 'eval',
    'constants_error_002.phpt': 'arrays not allowed in class constants',
    ...
    'static_properties_undeclared_read.phpt': "mmissing fatal",
    'tostring_001.phpt': "?",
    ...
    'array_access_001.phpt': "need review",
    'array_access_002.phpt': "need review",
    'array_access_003.phpt': "need review",
    'array_access_004.phpt': "need review",
    'array_access_005.phpt': "need review",
    'array_access_006.phpt': "need review",
    'array_access_007.phpt': "need review",
    'array_access_008.phpt': "need review",
    'array_access_009.phpt': "need review",
    'array_access_010.phpt': "need review",
    'array_access_011.phpt': "need review",
    'array_access_012.phpt': "need review",
    'array_access_013.phpt': "need review",
...
markers[lang_test_dir] = {
    ...
    'bug25922.phpt': "?",
    'bug26869.phpt': "DelayedHash",
    'bug30578.phpt': "?",
    'bug32828.phpt': "missing fatal (uncaught exception)",
    'bug35176.phpt': "?",
    'bug35382.phpt': "missing T_EVAL",
    ...
    'foreachLoop.008.phpt': "error wording",
    'foreachLoop.009.phpt': "?",
    'foreachLoop.011.phpt': "?",
    'foreachLoop.012.phpt': "T_EVAL",
    'foreachLoop.013.phpt': "parse error",
    'foreachLoop.014.phpt': "T_EVAL",
    'foreachLoop.015.phpt': "T_EVAL",
    ...
    'func_get_arg.001.phpt': "missing func_get_arg()",
    'func_get_arg.002.phpt': "missing func_get_arg()",
    'func_get_arg.003.phpt': "missing func_get_arg()",
    'func_get_arg.004.phpt': "missing func_get_arg()",
    'func_get_arg.005.phpt': "missing func_get_arg()",
    'func_get_arg_variation.phpt': "missing func_get_arg()",
    'include_variation3.phpt': "T_EVAL",
    ...
    'short_tags.003.phpt': "?",
    'short_tags.004.phpt': "?",
    'static_variation_001.phpt': "T_EVAL",
    'static_variation_002.phpt': "T_EVAL",
...
markers[output_test_dir] = {
    ...
    'bug60321.phpt': "undefined ob_get_status()",
    'ob_010.phpt': "our print_r() does not use output buffering",
    'ob_013.phpt': "undefined ob_list_handlers()",
    'ob_014.phpt': "undefined error_get_last()",
    'ob_015.phpt': "undefined error_get_last()",
    'ob_017.phpt': "flags",
    'ob_020.phpt': "undefined ob_list_handlers()",
    'ob_get_length_basic_001.phpt': "undefined ob_get_length()",
    'ob_get_length_error_001.phpt': "undefined ob_get_length()",
    'ob_get_status.phpt': "undefined ob_get_status()",
    'ob_implicit_flush_basic_001.phpt': "undefined ob_implicit_flush()",
    'ob_implicit_flush_basic_002.phpt': "undefined ob_implicit_flush()",
    'ob_implicit_flush_error_001.phpt': "undefined ob_implicit_flush()",
    'ob_implicit_flush_variation_001.phpt': "undefined ob_implicit_flush()",
    ...
    'ob_start_basic_unerasable_001.phpt': "ob_start() signature",
    ...
    'ob_start_error_001.phpt': "warning wording",
}
...
markers[mysql_test_dir] = SkipAll()
{
    ...
    'mysql_constants.phpt': " missing get_defined_constants() ",
...
markers[network_test_dir] = {
    'bug20134.phpt': 'missing fsockopen()',
    'bug41347.phpt': 'missing dns_check_record()',
    'closelog_basic.phpt': 'missing closelog()',
    'closelog_error.phpt': 'missing closelog()',
    'fsockopen_basic.phpt': 'missing stream_socket_server()',
    'fsockopen_error.phpt': 'missing fsockopen()',
    'fsockopen_variation1.phpt': 'missing stream_socket_server()',
    'fsockopen_variation2.phpt': 'missing stream_socket_server()',
...
markers[serialize_test_dir] = {
    ...
    'bug42919.phpt': 'does not work yet',
    'bug45706.phpt': 'does not work yet',
    'bug62836_1.phpt': 'does not work yet',
    'bug62836_2.phpt': 'does not work yet',
    'bug64354_1.phpt': 'does not work yet',
    'bug64354_2.phpt': 'does not work yet',
...
markers[date_test_dir] = SkipAll()

# markers[date_test_dir] = {
#     'bug52062-64bit.phpt': 'SKIP: segmentation fault',
#     'timestamp-in-dst.phpt': 'SKIP: segmentation fault',
...
markers[Zend_test_dir] = {
    ...
    '001.phpt': 'missing warnings around calling functions with wrong number '
                'of args',
    '002.phpt': 'undefined func_get_arg()',
    '003.phpt': '?',
    ...
    '019.phpt': '?',
    '020.phpt': 'undefined func_get_arg()',
    '021.phpt': "unexpected ':'",
    ...
    'argument_restriction_005.phpt': "missing ArrayAccess",
    ...
    'bug39018.phpt': "?",
    'bug39297.phpt': "missing ArrayAccess",
    'bug39542.phpt': "Cannot redeclare __autoload()",
    'bug40509.phpt': "?",
    'bug40621.phpt': "strict vs fatal error",
    'bug40705.phpt': "?",
    'bug40770.phpt': "missing fatal (memory size)",
    'bug40833.phpt': "missing ArrayAccess",
    'bug41026.phpt': "undefined register_shutdown_function()",
    'bug41209.phpt': "missing ArrayAccess",
    'bug41421.phpt': "undefined stream_wrapper_register()",
    'bug41633_2.phpt': "?",
    'bug41633_3.phpt': "infinite recursion",
    'bug41640.phpt': "undefined get_class_vars()",
    'bug41813.phpt': "?",
    'bug41919.phpt': "?",
    'bug42767.phpt': "undefined highlight_string()",
    'bug42802.phpt': "unexpected T_STRING",
    'bug42817.phpt': "Interpreter.CLONE",
    'bug42818.phpt': "Interpreter.CLONE",
    'bug42819.phpt': "unexpected T_STRING",
    'bug42820.phpt': "unexpected T_STRING",
    'bug42859.phpt': "unexpected T_STRING",
    'bug43027.phpt': "unexpected T_DECLARE",
    'bug43128.phpt': "T_EVAL",
    'bug43175.phpt': "__call via traditional factory should be caught",
    'bug43183.phpt': "unexpected T_STRING",
    'bug43200.phpt': "ReflectionClass",
    'bug43201.phpt': "?",
    'bug43332_1.phpt': "unexpected T_STRING",
    'bug43332_2.phpt': "unexpected T_STRING",
    'bug43343.phpt': "unexpected T_STRING",
    'bug43344_1.phpt': "unexpected T_STRING",
    'bug43344_10.phpt': "does not parse",
    'bug43344_11.phpt': "does not parse",
    'bug43344_12.phpt': "does not parse",
    'bug43344_13.phpt': "does not parse",
    'bug43344_2.phpt': "unexpected T_STRING",
    'bug43344_3.phpt': "unexpected T_STRING",
    'bug43344_4.phpt': "unexpected T_STRING",
    'bug43344_5.phpt': "unexpected T_STRING",
    'bug43344_6.phpt': "unexpected T_STRING",
    'bug43344_7.phpt': "unexpected T_STRING",
    'bug43344_8.phpt': "unexpected T_STRING",
    'bug43344_9.phpt': "unexpected T_STRING",
    'bug43450.phpt': "undefined memory_get_usage()",
    ...
    'bug44653.phpt': "unexpected T_STRING",
    'bug44660.phpt': "?",
    'bug44827.phpt': "missing warnings",
    'bug45178.phpt': "deprecated in PHP",
    'bug45180.phpt': "call_user_func()",
    ...
    'bug46665.phpt': "unexpected T_STRING",
    'bug46811.phpt': "SKIP: parse error in INI",
    'bug46813.phpt': "unexpected T_STRING",
    'bug47320.phpt': "$php_errormsg",
    'bug47516.phpt': "?",
    'bug47572.phpt': "missing notice",
    'bug47593.phpt': "unexpected T_STRING",
    'bug47699.phpt': "?",
    'bug47704.phpt': "?",
    'bug47714.phpt': "T_EVAL",
    'bug47836.phpt': "?",
    ...
    'bug48899.phpt': "?",
    'bug48912.phpt': "unexpected T_STRING",
    'bug48930.phpt': "?",
    ...
    'bug52060.phpt': "missing method_exists()",
    'bug52160.phpt': "?",
    ...
    'bug53727.phpt': "?",
    'bug53748.phpt': "unexpected T_STRING",
    'bug54013.phpt': "new_reflection()",
    'bug54265.phpt': "str_repeat()",
    'bug54268.phpt': "missing fatal (memory size)",
    'bug54305.phpt': "missing ReflectionMethod",
    'bug54367.phpt': "missing ArrayAccess",
    'bug54547.phpt': "?",
    'bug54585.phpt': "undefined _GET",
    'bug54624.phpt': "unexpected T_EVAL",
    'bug54804.phpt': "unexpected T_STRING",
    'bug54910.phpt': "?",
    'bug55007.phpt': "unexpected T_EVAL",
    'bug55086.phpt': "unexpected T_STRING",
    'bug55137.phpt': "unexpected T_STRING",
    'bug55156.phpt': "unexpected T_STRING",
    'bug55247.phpt': "unexpected {",
    'bug55509.phpt': "SKIP: LexerError (and also takes too much RAM)",
    'bug55705.phpt': "?",
    'bug55825.phpt': "unexpected T_STRING",
    'bug60099.phpt': "unexpected T_STRING",
    'bug60138.phpt': "missing RecursiveIteratorIterator",
    'bug60139.phpt': "missing gc_collect_cycles()",
    'bug60169.phpt': "unexpected :",
    'bug60444.phpt': "unexpected T_EVAL",
    'bug60536_001.phpt': "unexpected T_STRING",
    'bug60536_002.phpt': "unexpected T_STRING",
    'bug60536_003.phpt': "unexpected T_STRING",
    'bug60536_004.phpt': "unexpected T_STRING",
    'bug60536_005.phpt': "unexpected T_STRING",
    ...
    'bug64417.phpt': "unexpected T_STRING",
    ...
    'call_user_func_001.phpt': "namespace",
    ...
    'class_constants_004.phpt': "missing namespaces",
    ...
    'dereference_005.phpt': "missing ArrayAccess",
    ...
    'instanceof.phpt': "unexpected T_EVAL",
    ...
    'ns_007.phpt': "?",
    'ns_008.phpt': "?",
    'ns_009.phpt': "SKIP: NotImplementedError in the parser",
    'ns_010.phpt': "?",
    'ns_011.phpt': "?",
    'ns_012.phpt': "?",
    'ns_013.phpt': "?",
    ...
    'ns_017.phpt': "?",
    'ns_018.phpt': "?",
    'ns_019.phpt': "SKIP: NotImplementedError in the parser",
    'ns_020.phpt': "?",
    'ns_021.phpt': "?",
    'ns_022.phpt': "?",
    'ns_023.phpt': "?",
    'ns_024.phpt': "SKIP: NotImplementedError in the parser",
    'ns_025.phpt': "?",
    'ns_026.phpt': "?",
    'ns_027.phpt': "SKIP: NotImplementedError in the parser",
    'ns_028.phpt': "SKIP: NotImplementedError in the parser",
    'ns_029.phpt': "?",
    'ns_030.phpt': "?",
    'ns_031.phpt': "?",
    'ns_032.phpt': "SKIP: NotImplementedError in the parser",
    'ns_033.phpt': "?",
    'ns_034.phpt': "?",
    'ns_035.phpt': "?",
    'ns_036.phpt': "?",
    ...
    'ns_047.phpt': "?",
    'ns_048.phpt': "?",
    'ns_049.phpt': "SKIP: NotImplementedError in the parser",
    'ns_050.phpt': "?",
    'ns_051.phpt': "?",
    'ns_052.phpt': "?",
    'ns_053.phpt': "?",
    ...
    'ns_056.phpt': "?",
    'ns_057.phpt': "?",
    'ns_058.phpt': "SKIP: NotImplementedError in the parser",
    ...
    'ns_065.phpt': "?",
    'ns_066.phpt': "?",
    'ns_067.phpt': "SKIP: NotImplementedError in the parser",
    'ns_068.phpt': "SKIP: NotImplementedError in the parser",
    'ns_069.phpt': "?",
    'ns_070.phpt': "?",
    'ns_071.phpt': "?",
    'ns_072.phpt': "?",
    ...
    'ns_077_3.phpt': "?",
    'ns_077_4.phpt': "?",
    'ns_077_5.phpt': "SKIP: NotImplementedError in the parser",
    'ns_077_6.phpt': "SKIP: NotImplementedError in the parser",
    'ns_077_7.phpt': "SKIP: NotImplementedError in the parser",
    'ns_077_8.phpt': "SKIP: NotImplementedError in the parser",
    'ns_078.phpt': "?",
    'ns_079.phpt': "?",
    'ns_080.phpt': "?",
    'ns_081.phpt': "?",
    ...
    'objects_032.phpt': "missing ArrayAccess",
...
markers[spl_test_dir] = {
    ...
    'bug62978.phpt': "?",
    'bug63680.phpt': "?",
    'bug64023.phpt': "Missing namespace",
    'bug64106.phpt': "?",
    'bug64228.phpt': "?",
    'bug64264.phpt': "?",
    'bug65328.phpt': "?",
    ...
    'DirectoryIterator_by_reference.phpt': "Missing DirectoryIterator",
    'DirectoryIterator_empty_constructor.phpt': "Missing DirectoryIterator",
    'DirectoryIterator_getBasename_basic_test.phpt': "Missing DirectoryIterator",
    'DirectoryIterator_getBasename_pass_array.phpt': "Missing DirectoryIterator",
    'DirectoryIterator_getExtension_basic.phpt': "Missing DirectoryIterator",
    'DirectoryIterator_getGroup_basic.phpt': "Missing DirectoryIterator",
    'DirectoryIterator_getInode_basic.phpt': "Missing DirectoryIterator",
    'DirectoryIterator_getInode_error.phpt': "Missing DirectoryIterator",
    'DirectoryIterator_getOwner_basic.phpt': "Missing DirectoryIterator",
    'dit_001_noglob.phpt': "Missing DirectoryIterator",
    'dit_001.phpt': "Missing DirectoryIterator",
    'dit_002.phpt': "Missing DirectoryIterator",
    'dit_003.phpt': "Missing DirectoryIterator",
    'dit_004.phpt': "Missing DirectoryIterator",
    'dit_005.phpt': "Missing DirectoryIterator",
    'dit_006.phpt': "Missing DirectoryIterator",
    ...
    'filesystemiterator_flags.phpt': "Missing FileSystemIterator",
