...
class TestDateTime(BaseTestInterpreter):
    ...
    def test_construct_1(self):
        output = self.run('''
            ...
            echo (new DateTime('2000-01-01'))->format('Y-m-d');
        ''')
    ...
    def test_construct_3(self):
        output = self.run('''
            echo (new DateTime("2000-01-01 Pacific/Nauru"))->format('Y-m-d');
        ''')
    ...
    def test_construct_4(self):
        ...
        output = self.run('''
            echo (new DateTime("2000-01-01 +1200"))->format('Y-m-d');
        ''')
    ...
    def test_set_timezone_1(self):
        ...
        assert self.space.str_w(output.pop(0)) == 'Pacific/Chatham'

    def test_get_timezone_1(self):

        output = self.run('''
            $date = new DateTime('2000-01-01', new DateTimeZone('Pacific/Nauru'));
            echo get_class($date->getTimezone());

            $date->setTimezone(new DateTimeZone('UTC'));
            echo get_class($date->getTimezone());
        ''')

        assert self.space.str_w(output.pop(0)) == 'DateTimeZone'
        assert self.space.str_w(output.pop(0)) == 'DateTimeZone'
    ...
    def test_get_timezone_2(self):
        ...
        output = self.run('''
            $date = new DateTime("2000-01-01 Pacific/Nauru");
            echo $date->getTimezone()->getName();
        ''')
    ...
    def test_get_timezone_3(self):
        output = self.run('''
            echo (new DateTime("2000-01-01 +12:00"))->getTimezone()->getName();
            echo (new DateTime("2000-01-01 +10:00"))->getTimezone()->getName();
            echo (new DateTime("2000-01-01 -10:00"))->getTimezone()->getName();
            echo (new DateTime("2000-01-01 -00:00"))->getTimezone()->getName();
        ''')

        assert self.space.str_w(output.pop(0)) == '+12:00'
        assert self.space.str_w(output.pop(0)) == '+10:00'
        assert self.space.str_w(output.pop(0)) == '-10:00'
        assert self.space.str_w(output.pop(0)) == '+00:00'
    ...
    def test_serialize(self):
        ...
        assert self.space.str_w(output[0]) == \
            'O:8:"DateTime":3:{s:4:"date";s:19:"2005-07-14 22:30:41";s:13:"timezone_type";i:3;s:8:"timezone";s:13:"Europe/London";}'
