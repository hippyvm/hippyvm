...
class ObjSpace(object):
    ...
    (tp_int, tp_float, tp_str, tp_array, tp_null, tp_bool,
     ...
     tp_mysql_link, tp_mysql_result) = range(12)
    ...
    def str_eq(self, w_one, w_two, quiet=False):
        ...
        return self._compare(w_one, w_two) == 0
    ...
    def is_w(self, w_a, w_b):
        return self._compare(w_a, w_b, strict=True) == 0
    ...
    def _get_callback(self, w_obj):
        ...
        if w_obj.tp == self.tp_str:
            ...
            key = name.lower()
            try:
                return self.ec.interpreter.functions[key]
            except KeyError:
