...
static inline void SnefruTransform(SNEFRU_CTX *context, const unsigned char input[32])
{
	int i, j;
...
void SNEFRUInit(SNEFRU_CTX *context)
{
...
void SNEFRUUpdate(SNEFRU_CTX *context, const unsigned char *input, size_t len)
{
...
void SNEFRUFinal(unsigned char digest[32], SNEFRU_CTX *context)
{
	uint32_t i, j;
