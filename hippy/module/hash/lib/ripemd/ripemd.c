 ...
 */
void ripemd128_init(ripemd128_ctx * context)
{
 ...
 */
void ripemd256_init(ripemd256_ctx * context)
{
	context->count[0] = context->count[1] = 0;
	/* Load magic initialization constants.
	 */
 ...
 */
void ripemd320_init(ripemd320_ctx * context)
{
	context->count[0] = context->count[1] = 0;
	/* Load magic initialization constants.
	 */
...
/* {{{ ripemd128_update
   ...
   context.
 */
void ripemd128_update(ripemd128_ctx * context, const unsigned char *input, unsigned int inputLen)
{
...
/* {{{ ripemd256_update
   ...
   context.
 */
void ripemd256_update(ripemd256_ctx * context, const unsigned char *input, unsigned int inputLen)
{
	unsigned int i, index, partLen;
...
/* {{{ ripemd160_update
   ...
   context.
 */
void ripemd160_update(ripemd160_ctx * context, const unsigned char *input, unsigned int inputLen)
{
	unsigned int i, index, partLen;
...
/* {{{ ripemd320_update
   ...
   context.
 */
void ripemd320_update(ripemd320_ctx * context, const unsigned char *input, unsigned int inputLen)
{
	unsigned int i, index, partLen;
 ...
 */
void ripemd128_final(unsigned char digest[16], ripemd128_ctx * context)
{
	...
	ripemd128_update(context, PADDING, padLen);

	/* Append length (before padding) */
	ripemd128_update(context, bits, 8);
...
/* {{{ ripemd256_final
   ...
   the message digest and zeroizing the context.
 */
void ripemd256_final(unsigned char digest[32], ripemd256_ctx * context)
{
	unsigned char bits[8];
	unsigned int index, padLen;
	...
	index = (unsigned int) ((context->count[0] >> 3) & 0x3f);
	padLen = (index < 56) ? (56 - index) : (120 - index);
	ripemd256_update(context, PADDING, padLen);

	/* Append length (before padding) */
	ripemd256_update(context, bits, 8);
...
void ripemd160_final(unsigned char digest[20], ripemd160_ctx * context)
{
	...
	index = (unsigned int) ((context->count[0] >> 3) & 0x3f);
	padLen = (index < 56) ? (56 - index) : (120 - index);
	ripemd160_update(context, PADDING, padLen);

	/* Append length (before padding) */
	ripemd160_update(context, bits, 8);
...
/* {{{ ripemd320_final
   ...
   the message digest and zeroizing the context.
 */
void ripemd320_final(unsigned char digest[40], ripemd320_ctx * context)
{
	unsigned char bits[8];
	unsigned int index, padLen;
	...
	index = (unsigned int) ((context->count[0] >> 3) & 0x3f);
	padLen = (index < 56) ? (56 - index) : (120 - index);
	ripemd320_update(context, PADDING, padLen);

	/* Append length (before padding) */
	ripemd320_update(context, bits, 8);
